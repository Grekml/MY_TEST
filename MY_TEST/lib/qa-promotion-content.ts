...
export const closingSummary: ClosingSummary = {
  headline: "Мой вклад в качество релизов измерим цифрами и заметен в результате бизнеса.",
  body: `Мой вклад в проекты — это не точечные проверки, а системная работа с качеством на уровне продукта и процессов. Я помогаю командам выпускать изменения предсказуемо: заранее выявлять риски, стабилизировать релизы и снижать стоимость ошибок для бизнеса.

На уровне компании этот подход усиливает общий стандарт качества: повышает прозрачность решений, ускоряет цикл от дефекта до исправления и укрепляет доверие к продукту со стороны пользователей, команды и стейкхолдеров.`,
